/*=====================================================
    UCMI - MOTOR COMPRENSIÓN AUDITIVA
=====================================================*/

const UCMIMotorComprensionAuditiva = {
    ...
    generar: function(configuracion){
        ...
        if(!contenedor){
            ...
            console.error(
                "UCMIMotorComprensionAuditiva: no existe el contenedor."
            );
        ...
        if(!datos){
            ...
            console.error(
                "UCMIMotorComprensionAuditiva: no se recibieron datos."
            );
        ...
        */
        ...
        zona.className =
            "ejercicio-comprension-auditiva";
        ...
        */
        ...
        tituloAudio.textContent =
            datos.titulo || "";

        tituloAudio.style.textAlign =
            "center";
        ...
        */
        ...
        contenedorPreguntas.className =
            "preguntas-comprension-auditiva";
            ...
            datos.preguntas.forEach(
                (pregunta, indice) => {
                    ...
                    */
                    ...
                    enunciado.className =
                        "enunciado-comprension-auditiva";
            ...
            function(){
                ...
                preguntas.forEach(
                    (bloquePregunta) => {
                        ...
                        let resultado =
                            bloquePregunta.querySelector(
                                ".resultado-comprension-auditiva"
                            );
